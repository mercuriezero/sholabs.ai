      ...
      <div className="mx-auto max-w-6xl px-6 py-16">
        <div className="grid gap-12 md:grid-cols-[1.4fr_1fr_1fr]">
          ...
          <nav aria-label="Services">
            ...
            <ul className="mt-5 space-y-3 text-sm">
              {[
                ...
                <li key={label}>
                  <a href={pathname === "/" ? `#${id}` : `/#${id}`} data-testid={`footer-service-${label.toLowerCase().replace(/\s+/g, "-")}`} className="text-neutral-600 transition-colors hover:text-black">
                    {label}
                  </a>
                </li>
              ))}
              <li>
                <Link href="/fractional-cxo" data-testid="footer-service-fractional-ai-cxo" className="text-neutral-600 transition-colors hover:text-black">
                  Fractional AI CXO
                </Link>
              </li>
            </ul>
          ...
          <nav aria-label="Company">
            ...
            <ul className="mt-5 space-y-3 text-sm">
              <li><a href={pathname === "/" ? "#process" : "/#process"} data-testid="footer-link-process" className="text-neutral-600 transition-colors hover:text-black">Process</a></li>
              <li><a href={pathname === "/" ? "#why-us" : "/#why-us"} data-testid="footer-link-why-us" className="text-neutral-600 transition-colors hover:text-black">Why us</a></li>
              <li><a href={pathname === "/" ? "#faq" : "/#faq"} data-testid="footer-link-faq" className="text-neutral-600 transition-colors hover:text-black">FAQ</a></li>
              <li><a href={pathname === "/" ? "#hero-cta" : "/#hero-cta"} data-testid="footer-link-contact" className="text-neutral-600 transition-colors hover:text-black">Start a brief</a></li>
            </ul>
          </nav>
        </div>
